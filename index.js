...
// When teh makeimagescommand is run, it will replace each 'image' field for every rooms entry with a URL to an image generated by the AI that has been rehosted on IMGUR.... maybe break this up a bit
...
// Changed this to only run once because it was making changes and triggering itself.
roomsRef.once('value', (snapshot) => {
